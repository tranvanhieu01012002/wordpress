...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_pet_shop_slider_hide_show', false) != '' || get_theme_mod( 'vw_pet_shop_resp_slider_hide_show', false) != '') { ?>
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if( get_theme_mod('vw_pet_shop_slider_content_hide_show',true) != ''){ ?>
                    <p class=" wow rollIn delay-1000" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_pet_shop_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_pet_shop_slider_excerpt_number','30')))); ?></p>
                  <?php } ?>
                  <?php if( get_theme_mod('vw_pet_shop_slider_button_text','Shop More') != ''){ ?>
                    <div class="more-btn wow rollIn delay-1000" data-wow-duration="2s">
                      <a class="view-more" href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html(get_theme_mod('vw_pet_shop_slider_button_text',__('Shop More','vw-pet-shop')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_pet_shop_slider_button_text',__('Shop More','vw-pet-shop')));?></span></a>
                    </div>
                  <?php } ?>
                </div>
              </div>

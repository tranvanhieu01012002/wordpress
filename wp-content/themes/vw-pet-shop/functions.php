...
function vw_pet_shop_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/premium-pet-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-pet-shop' ) .'</a></span>';
	echo '</div>';
}
...
function vw_pet_shop_scripts() {
	...
	wp_enqueue_style( 'vw-pet-shop-effect', esc_url(get_template_directory_uri()).'/css/effect.css' );
	...
	wp_enqueue_script( 'vw-pet-shop-customscripts', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
	
	if (get_theme_mod('vw_pet_shop_animation', true) == true){
		wp_enqueue_style( 'vw-pet-shop-animate-css', esc_url(get_template_directory_uri()).'/css/animate.css' );
		wp_enqueue_script( 'vw-pet-shop-jquery-wow', esc_url(get_template_directory_uri()) . '/js/wow.js', array('jquery') );
	}
...
define('VW_PET_SHOP_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-vw-pet-shop/','vw-pet-shop'));
...
define('VW_PET_SHOP_BUY_NOW',__('https://www.vwthemes.com/themes/premium-pet-wordpress-theme/','vw-pet-shop'));
define('VW_PET_SHOP_LIVE_DEMO',__('https://vwthemes.net/vw-pet-shop-pro/','vw-pet-shop'));
define('VW_PET_SHOP_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-pet-shop-pro/','vw-pet-shop'));
...
define('VW_PET_SHOP_CREDIT',__('https://www.vwthemes.com/themes/free-pet-wordpress-theme/','vw-pet-shop'));
...
function vw_pet_shop_tagline_hide_show(){
	if(get_theme_mod('vw_pet_shop_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}

...
class Own_Shop_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'own-shop-radio-image-control-css', get_parent_theme_file_uri( 'inc/customizer/custom-controls/radio-images/radio-image.min.css', array(), '1.0', 'all' ));
	}

 ...
 */
function bakerystore_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function bakerystore_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function bakerystore_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function bakerystore_sanitize_float( $input ) {
 ...
 */
function bakerystore_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function bakerystore_sanitize_html( $html ) {
 ...
 */
function bakerystore_sanitize_image( $image, $setting ) {
 ...
 */
function bakerystore_sanitize_nohtml( $nohtml ) {
 ...
 */
function bakerystore_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function bakerystore_sanitize_range_value( $number, $setting ) {
 ...
 */
function bakerystore_sanitize_select( $input, $setting ) {
 ...
 */
function bakerystore_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function bakerystore_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function bakerystore_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
